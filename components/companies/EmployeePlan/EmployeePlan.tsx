      ...
      <div className="layout-wrapper py-8">
        <div className="flex items-center">
          <div>
            ...
            <p className="text-text-300 text-xl py-2">
            ...
            {plans.map((i: any) => {
              return (
                <li
                  ...
                  key={i.plan}>
                  <h3 className="text-text-200 opacity-60 text-sm font-medium uppercase leading-[130%] tracking-[0.3em] py-4">
                    {i.plan}
                  </h3>
                  <h4 className="text-text-200 text-xl font-semibold leading-[130%] py-2">
                    {i.capsules}
                  </h4>
